...
class ApiV1PostCommentControllerTest(
    ...
    fun t2() {
        ...
        comments.forEachIndexed { index, postComment ->
            resultActions
                .andExpect(MockMvcResultMatchers.jsonPath("$[$index].id").value(postComment.id))
                .andExpect(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[$index].authorId").value(postComment.author.id))
                .andExpect(MockMvcResultMatchers.jsonPath("$[$index].authorName").value(postComment.author.name))
                .andExpect(MockMvcResultMatchers.jsonPath("$[$index].postId").value(postComment.post.id))
                .andExpect(MockMvcResultMatchers.jsonPath("$[$index].content").value(postComment.content))
        }
    }
